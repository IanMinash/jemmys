"""
Django settings for jemmys project.
...
STATIC_DIR = os.path.join(BASE_DIR, 'jemmys','static')
MEDIA_ROOT = os.path.join(BASE_DIR, 'jemmys','media')
...
WSGI_APPLICATION = 'jemmys.wsgi.application'
